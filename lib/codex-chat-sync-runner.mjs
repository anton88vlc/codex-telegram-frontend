...
import { listQuickstartWorkItemsFromStore } from "./thread-store.mjs";
...
export async function syncAutoCodexChatTopics({
  ...
  listQuickstartWorkItemsFn = (_threadsDbPath, options) => listQuickstartWorkItemsFromStore(config, options),
