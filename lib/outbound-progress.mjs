...
export const DEFAULT_OUTBOUND_PROGRESS_COMPLETE_MODE = "delete";
...
export function normalizeOutboundProgressCompleteMode(value) {
  const normalized = normalizeText(value).toLowerCase();
  if (["delete", "done"].includes(normalized)) {
    return normalized;
  }
  return DEFAULT_OUTBOUND_PROGRESS_COMPLETE_MODE;
}
