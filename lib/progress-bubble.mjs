...
const PROGRESS_STEPS = [
  { delayMs: 2_500, text: "Working..." },
  { delayMs: 6_000, text: "Still working..." },
  {
    delayMs: 14_000,
    text: "Still working. If the Mac slept, Codex restarted, or the connection hiccuped, this may recover or time out.",
  },
  {
    delayMs: 30_000,
