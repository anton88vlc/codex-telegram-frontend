...
import {
  findActiveThreadSuccessorsFromStore,
  getThreadByIdFromStore,
...
export async function validateBindingForSendWithRescue({
  ...
  findActiveThreadSuccessorsFn = (_threadsDbPath, thread, options) =>
    findActiveThreadSuccessorsFromStore(config, thread, options),
  getThreadByIdFn = (_threadsDbPath, threadId) => getThreadByIdFromStore(config, threadId),
  isClosedSyncBindingFn = isClosedSyncBinding,
  isThreadDbOptionalBindingFn = isThreadDbOptionalBinding,
  logEventFn = logBridgeEvent,
