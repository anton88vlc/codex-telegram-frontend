...
export async function loadState(statePath) {
  ...
  const state = {
    ...
    privateTopicTitles:
      parsed?.privateTopicTitles && typeof parsed.privateTopicTitles === "object" ? parsed.privateTopicTitles : {},
  };
  return state;
}
...
export function mergeState(current, persisted) {
  ...
  const persistedPrivateTopicTitles =
    persisted.privateTopicTitles && typeof persisted.privateTopicTitles === "object"
      ? persisted.privateTopicTitles
      : {};
  current.privateTopicTitles =
    current.privateTopicTitles && typeof current.privateTopicTitles === "object" ? current.privateTopicTitles : {};
  current.privateTopicTitles = {
    ...persistedPrivateTopicTitles,
    ...current.privateTopicTitles,
  };
